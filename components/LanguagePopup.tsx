        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-xl">
                ...
                <motion.div
                    ...
                    className="relative w-full max-w-lg glass-panel p-8 md:p-12 text-center space-y-8 border border-white/10 shadow-3xl bg-brand-deep/50 overflow-hidden"
                >
                    {/* Top Accent Line */}
                    ...
                    <div className="space-y-4">
                        <motion.div
                            ...
                            className="inline-block px-3 py-1 rounded-full border border-brand-primary/20 bg-brand-primary/5 text-brand-primary text-[10px] font-mono tracking-widest uppercase mb-4"
                        >
