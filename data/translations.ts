export const translations: Record<string, any> = {
    fr: {
        ...
        questionnaire_ui: {
            ...
            skip_photo_modal_title: "La photo améliore l'analyse",
            skip_photo_modal_message: "Une photo nette permet à notre IA d'identifier avec bien plus de précision la nature de votre lésion cutanée. Sans photo, l'analyse se basera uniquement sur vos réponses au questionnaire, ce qui peut réduire la fiabilité du résultat.",
            skip_photo_modal_add_btn: "Ajouter une photo",
            skip_photo_modal_continue_btn: "Continuer sans photo",
        ...
        auth: {
            ...
            email_already_used: "Cet email est déjà utilisé. Veuillez vous connecter.",
    ...
    en: {
        ...
        questionnaire_ui: {
            ...
            skip_photo_modal_title: "Photo improves accuracy",
            skip_photo_modal_message: "A clear photo allows our AI to identify the nature of your skin lesion with much greater precision. Without a photo, the analysis will rely solely on your questionnaire answers, which may reduce the reliability of the result.",
            skip_photo_modal_add_btn: "Add a photo",
            skip_photo_modal_continue_btn: "Continue without photo",
        ...
        auth: {
            ...
            email_already_used: "This email is already in use. Please log in.",
    ...
    nl: {
        ...
        questionnaire_ui: {
            ...
            skip_photo_modal_title: "Foto verbetert de analyse",
            skip_photo_modal_message: "Een duidelijke foto stelt onze AI in staat de aard van uw huidletsel veel nauwkeuriger te identificeren. Zonder foto baseert de analyse zich uitsluitend op uw antwoorden op de vragenlijst, wat de betrouwbaarheid van het resultaat kan verminderen.",
            skip_photo_modal_add_btn: "Foto toevoegen",
            skip_photo_modal_continue_btn: "Doorgaan zonder foto",
        ...
        auth: {
            ...
            email_already_used: "Dit e-mailadres is al in gebruik. Log in.",
    ...
    es: {
        ...
        questionnaire_ui: {
            ...
            skip_photo_modal_title: "La foto mejora el análisis",
            skip_photo_modal_message: "Una foto clara permite a nuestra IA identificar con mucha más precisión la naturaleza de su lesión cutánea. Sin foto, el análisis se basará únicamente en sus respuestas al cuestionario, lo que puede reducir la fiabilidad del resultado.",
            skip_photo_modal_add_btn: "Añadir una foto",
            skip_photo_modal_continue_btn: "Continuar sin foto",
        ...
        auth: {
            ...
            email_already_used: "Este correo electrónico ya está en uso. Por favor, inicie sesión.",
